  ...
  const fetchMonthlyReport = async () => {
    ...
    try {
      const res = await axios.get(
        `http://localhost:3000/api/report/monthlysales/${month}/${year}`
      );
  ...
  const fetchAdvancedReports = async () => {
    ...
    try {
      const [topRes, deadRes, profitRes, revenueRes] = await Promise.all([
        axios.get("http://localhost:3000/api/report/top-products"),
        axios.get("http://localhost:3000/api/report/dead-stock"),
        axios.get("http://localhost:3000/api/report/profit-summary"),
        axios.get("http://localhost:3000/api/report/revenue-by-product"),
      ]);
